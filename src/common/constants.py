...
SERVICE_TYPE_SYNONYM_PULLER = "synonym_puller"
SERVICE_TYPES = [SERVICE_TYPE_ESSENTIAL, SERVICE_TYPE_FILE, SERVICE_TYPE_METADATA, SERVICE_TYPE_EXPORT, SERVICE_TYPE_PV_PULLER, SERVICE_TYPE_SYNONYM_PULLER]
