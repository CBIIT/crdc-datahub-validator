...
from common.constants import MODELS_DEFINITION_FILE, LIST_DELIMITER_PROP, DEF_MAIN_NODES, PROPERTY_NAMES
...
class ModelFactory:
    ...
    def create_model(self, data_common, version):
        ...
        try:
            ...
            model_reader.model.update({DEF_FILE_NODES: v[DEF_SEMANTICS][DEF_FILE_NODES], DEF_MAIN_NODES: v[DEF_SEMANTICS][DEF_MAIN_NODES], PROPERTY_NAMES: v[DEF_SEMANTICS][PROPERTY_NAMES]})
