                    ...
                    if data.get(SQS_TYPE) == TYPE_LOAD and data.get(BATCH_ID):
                        ...
                        try:
                            ...
                            if result and validator.download_file_list and len(validator.download_file_list) > 0:
                                ...
                                data_loader = DataLoader(validator.model, batch, mongo_dao, validator.bucket, validator.root_path, validator.datacommon, validator.submission.get(SUBMISSION_INTENTION), model_store)
